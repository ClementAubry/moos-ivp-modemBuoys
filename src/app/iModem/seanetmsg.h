...
class SeaNetMsg_ProgBlock : public SeaNetMsg
{
public:
  SeaNetMsg_ProgBlock(const char & destinationNode, const char & blockNum,const std::string &payload) : SeaNetMsg(destinationNode) {
    ...
    // m_data.append(payload);
    //On ajoute le fin de chaine (0x0A)
    const char lf[] = {0x0A};
    m_data.append(lf);
  }
};
class SeaNetMsg_FirstProgBlockM504503 : public SeaNetMsg
{
public:
  SeaNetMsg_FirstProgBlockM504503(const char & destinationNode, const char & blockNum) : SeaNetMsg(destinationNode) {
    //On construit le message global
    const char msg[] = {0x40,0x30,0x30,0x38,0x41,0x8A,0x00,0xFF,m_destinationNode,0x85,0x15,0x80,m_destinationNode,blockNum,};
    // m_data.reserve(sizeof(msg)+sizeof(payload)+1);
    m_data.assign(msg, sizeof(msg));
  }
};
class SeaNetMsg_FirstProgBlockM396301 : public SeaNetMsg
{
public:
  SeaNetMsg_FirstProgBlockM396301(const char & destinationNode, const char & blockNum) : SeaNetMsg(destinationNode) {
    //On construit le message global

    const char msg[] = {0x40,0x30,0x30,0x38,0x41,0x8A,0x00,0xFF,m_destinationNode,0x85,0x15,0x80,m_destinationNode,blockNum,};
    // m_data.reserve(sizeof(msg)+sizeof(payload)+1);
    m_data.assign(msg, sizeof(msg));
  }
};
